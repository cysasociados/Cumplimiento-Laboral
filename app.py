...
# URL DE TU APPS SCRIPT (Sacada de tu captura)
...
# IDs de Google Sheets (Actualizados con tu nuevo link de ID_Empresas)
ID_AVANCE = "1H-L5zzWlm1_bubJab3G_kztzWBfgUZuPnFvrbcFvj7Y"
ID_EMPRESAS = "1sC0BNZTc1UuOVhl9UqaBqCehuXso3AxqBVwQ7tm4Ybo" # <--- Tu link de ID_Empresas
    ...
    if not df_av.empty:
        ...
        with c_cert:
            ...
            if mes_sel != "AÑO COMPLETO":
                try:
                    # Buscamos el ID_Carpeta en tu nuevo archivo
                    id_carpeta = str(df_eecc[df_eecc['Empresa'] == emp_v]['ID_Carpeta'].iloc[0]).strip()
                ...
                except: st.error("No se encontró el ID_Carpeta para esta empresa.")
