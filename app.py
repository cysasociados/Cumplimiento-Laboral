...
with tabs[0]:
    ...
    if not df_av.empty:
        ...
        with col_d:
            ...
            mes_pdf = st.selectbox("Seleccione Mes para el PDF:", cols_m_sidebar)
...
if rol != "USUARIO":
    with tabs[1]:
        ...
        df_empresas = cargar_datos(ID_EMPRESAS, "HOJA1")
        ...
        if not df_masa.empty:
            ...
            if col_contrato:
                ...
                if not plazo_f.empty:
                    ...
                    st.dataframe(plazo_f, use_container_width=True)
