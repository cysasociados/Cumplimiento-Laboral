...
with tabs[3]:
    ...
    with col_d_inst:
        ...
        txt_d = "<li>Contrato de Trabajo </li><li>Anexo de Contrato</li><li>Cédula Identidad</li><li>Cert. Afiliacion AFP/Salud</li><li>Comprobante Registro Contrato DT</li><li>Comprobante Entrega RIOHS</li>" if "Alta" in acc_dot else "<li>Finiquito Firmado</li><li>Comprobante Pago Finiquito</li></li><li>Anexo Traslado</li>"
        st.markdown(f"""
